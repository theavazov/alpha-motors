...
@section('content')
    <div class="page-top">
        ...
        <a href="{{ route('services.create') }}" class="c-btn">Добавить</a>
    </div>
                ...
                <tbody>
                    @foreach ($data as $object)
                        <tr>
                            ...
                            <td>
                                <div class="events-td">
                                    <a href="{{ route('services.edit', ['id' => $object['id']]) }}" class="event-btn edit">
                                    ...
                                    <a href="{{ route('services.destroy', ['id' => $object['id']]) }}"
